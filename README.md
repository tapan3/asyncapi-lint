...
| ------------------------------------------ | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------- |
| `asyncapi-info-description`| error |  `Write a well formatted brief description of your API with atleast 30 char long` | yes                                                                                 |
| `asyncapi-info-contact` | error | `Requires the Contact info object defined in your API` | no                                                                                                                                                                                     |
| `asyncapi-info-contact-email` |error | `Always provide contact email (preferred group emailId)` | no                                                                                                                                                                                     |
| `asyncapi-info-version` |error | `Always use semantic versioning` | yes                                                                                                                                                                                     | 
| `asyncapi-channel-name` | error | `Follow naming standard for Topic [Read more](https://allen.ingka.com/docs/default/component/api-standards/EventAPI/topic-naming-standards/)` | no                                                                                                                                                                                     |
| `asyncapi-channel-name` | error | `If specified, Topic Properties are necessary for a particular type messaging broker or platform [Read more](https://allen.ingka.com/docs/default/component/api-standards/EventAPI/#platform-specific-standards)` | no                                                                                                                                                                                     |
| `asyncapi-component-message` | warn | `Always provide event version as major version only` | no                                                                                                                                                                                     |
| `asyncapi-component-schema` | error | `Always provide Schema version as major.minor version only` | no                                                                                                                                                                                     |
| `asyncapi-channel-x-ingka-attributes.visibility` | error | `Each event must use x-ingka-attributes.visibility and value must be used from pre-define enumerations {private,ikea-internal ,ikea-partner,ingka-internal }` [Read more](https://allen.ingka.com/docs/default/component/api-standards/common/visibility/) | no                                                                                                                                                                                     |
| `asyncapi-channel-x-ingka-attributes.reusability` | error | `Each event must use x-ingka-attributes.reusability and value must be used from pre-define enumerations {business , system , single-purpose}` [Read more](https://allen.ingka.com/docs/default/component/api-standards/common/reusability/) | no                                                                                                                                                                                     |
| `asyncapi-channel-x-ingka-attributes.status` | error | `Each event must use x-ingka-attributes.status and value must be used from pre-define enumerations  {draft,published ,deprecated,retired}` [Read more](https://allen.ingka.com/docs/default/component/api-standards/common/lifecycle/) | no                                                                                                                                                                                     |
